...
pub use crate::type_uuid::type_ids::{
    ...
    AZSTD_STRING_LEGACY_XML, AZSTD_STRING_XML_ALIAS, AZSTD_UNORDERED_MAP,
    AZSTD_UNORDERED_MULTIMAP, AZSTD_UNORDERED_MULTISET, AZSTD_UNORDERED_SET, AZSTD_VECTOR,
    AZSTD_VECTOR_XML_ALIAS, BOOL, CHAR, COLOR, COLORB, COLORF, CRC32, DOUBLE, ENTITY_ID, FLOAT,
    INT, LONG, MATRIX3X3, MATRIX4X4, OBB, PLANE, PLATFORM_ID, QUATERNION, SHORT, SIGNED_CHAR,
    TRANSFORM, VARIANT, VECTOR_FLOAT, VECTOR2, VECTOR3, VECTOR4, VOID,
};
