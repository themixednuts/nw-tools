...
struct NetworkSchemaArgs {
    #[command(flatten)]
    catalog: CatalogArgs,
    /// Ghidra static report generated by scripts/ghidra/ReplicatedStateSchemaExtractor.java.
...
fn network_schema(args: &NetworkSchemaArgs) -> Result<()> {
    ...
    let mut schema = NetworkSchema::from_replicated_state_ghidra_report(&report)
